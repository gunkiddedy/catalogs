...
-- Dumping database structure for catalogss
CREATE DATABASE IF NOT EXISTS `catalogss` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `catalogss`;

-- Dumping structure for table catalogss.kabupatens
...
-- Dumping data for table catalogss.kabupatens: ~514 rows (approximately)
/*!40000 ALTER TABLE `kabupatens` DISABLE KEYS */;
INSERT INTO `kabupatens` (`id`, `provinsi_id`, `name`) VALUES
...
-- Dumping data for table catalogss.kecamatans: ~7.215 rows (approximately)
/*!40000 ALTER TABLE `kecamatans` DISABLE KEYS */;
INSERT INTO `kecamatans` (`id`, `kabupaten_id`, `name`) VALUES
